    ...
    return (
        <Accordion type="single" className="space-y-4" collapsible>
            <AccordionItem
                ...
                value="triggers"
                className="flex flex-col gap-4 rounded-lg bg-slate-100 p-4 px-4"
            >
                <AccordionTrigger
                    className={cn(
                ...
                <AccordionContent className="flex flex-col gap-4 ">
                    <div className="scroll flex max-h-[40vh] flex-col gap-4 overflow-x-clip  overflow-y-scroll py-2  pr-1 ">
                        <div className="w-full rounded border border-slate-300 bg-slate-50 px-2 py-[0.33rem] font-medium">
                            Manual Activation
                        </div>
