...
export function TriggerSelector({
    ...
    return (
        <div className="flex h-fit  flex-1 flex-row items-center divide-x divide-slate-300 overflow-clip rounded  border  border-slate-300 bg-white ">
            <Popover>
                <PopoverTrigger
                    asChild
            ...
            <div
                ...
                className=" flex aspect-square items-center justify-center rounded-none bg-transparent px-2 text-slate-800 hover:bg-slate-100 hover:text-slate-900"
            >
                <Trash weight="bold" />
            </div>
        </div>
