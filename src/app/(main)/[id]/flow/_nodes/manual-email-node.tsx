        ...
        >
            <div className=" !z-20 flex flex-col items-center justify-start gap-4 !border-none bg-white p-4   ">
                <div className="flex w-full items-center justify-start gap-2 ">
                    ...
                    {isComplete ? (
                        <div className="flex-initial text-xs font-semibold text-slate-500">
                            {`#${nodePosition}`}
                        </div>
                    ) : (
                ...
                <div className="flex w-full flex-initial items-center justify-between text-xs font-semibold text-slate-500">
