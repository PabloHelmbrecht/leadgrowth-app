...
import {
    ...
    resetAllFiltersAtom,
    tableAtom,
} from "~/lib/stores/companies-table"

//Hooks
import { useCompanies, type Company } from "~/lib/hooks/use-companies"
    ...
    return (
        ...
        >
            ...
            <main className="flex h-full w-full flex-col gap-6 p-6">
                ...
                <DataTable<Company, unknown> columns={columns} />
            </main>
        </tableContext.Provider>
    )
}
